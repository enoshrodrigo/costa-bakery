...
if(isset($_POST['submit'])){
    ...
    if( $addIngredient->insertOData()){
        ...
        $ingredient_id = json_encode($addIngredient->selectOData('ingredient_name="'.$_POST['ingredient_name'].'"', 'ingredient_id'));
     $ingredient_id = json_decode($ingredient_id,true);
       ...
       foreach($ingredient_id as $ing){
        ...
        $addIngredient->setTable('ingredientvalue');
        $addIngredient->setFields(array(
            ...
            'ingredientvalue_date_end' => $_POST['ingredientvalue_date_end']
        ));
        if( $addIngredient->insertOData()){
